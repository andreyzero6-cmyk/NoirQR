...
const MenuPageWrapper = () => {
  const { slug } = new URLSearchParams(window.location.pathname.split('/').slice(-1)[0]);
  const pathSlug = window.location.pathname.split('/menu/')[1];
  return <MenuPage slug={pathSlug} />;
};
    ...
    <div style={styles.homePage}>
      ...
      <header style={styles.header}>
        <div style={styles.container}>
          ...
          <nav style={styles.nav}>
            ...
            <Link to="/admin-secret" style={styles.adminBtn}>
              <Icon name="admin" size={16} /> Админ
            </Link>
          </nav>
        </div>
      </header>
      ...
      <section style={styles.hero}>
        <div style={styles.heroContent}>
          ...
          <div style={styles.heroCTA}>
            <Link to="/admin-secret" style={styles.primaryBtn}>
        ...
        <div style={styles.container}>
          ...
          <div style={styles.featuresGrid}>
            ...
            <FeatureCard
              ...
              desc="Получайте заказы и уведомления прямо в Telegram"
            />
            <FeatureCard
              icon="phone"
      ...
      <section style={styles.ctaSection}>
        <div style={styles.container}>
          ...
          <Link to="/admin-secret" style={styles.largeCTA}>
        ...
        <div style={styles.container}>
          <div style={styles.footerContent}>
            ...
            <div style={styles.footerLinks}>
              ...
              <a href="#features" style={styles.footerLink}>Возможности</a>
              <a href="/" style={styles.footerLink}>На главную</a>
            </div>
            <div style={styles.footerLinks}>
